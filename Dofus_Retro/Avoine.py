...
image_paths = {
    ...
    'Cereale_0': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Avoine_0.png'),
    'Cereale_1': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Avoine_1.png'),
    'Cereale_2': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Avoine_2.png'),
...
templates = [
    # Image conseillé : 144px x 144px en PNG
