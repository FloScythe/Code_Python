...
image_paths = {
    ...
    'Cereale_0': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Ble_0.png'),
    'Cereale_1': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Ble_1.png'),
    'Cereale_2': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Ble_2.png'),
    'Cereale_3': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Ble_3.png'),
