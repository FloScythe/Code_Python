...
image_paths = {
    ...
    'Cereale_0': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Chanvre_0.png'),
    'Cereale_1': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Chanvre_1.png'),
    'Cereale_2': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Chanvre_2.png'),
    'Cereale_3': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Chanvre_3.png'),
...
templates = [
    ...
    cv2.imread(image_paths['Cereale_3']),
