...
image_paths = {
    ...
    'Cereale_0': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Orge_0.png'),
    'Cereale_1': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Orge_1.png'),
    'Cereale_2': os.path.join(bundle_dir, 'Image', 'Metier', 'Paysan', 'Orge_2.png'),
